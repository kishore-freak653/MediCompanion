            ...
            {sortedTimes.map((time) => {
              ...
              return (
                <div key={time} className="grid grid-cols-8">
                  <div className="p-4 border-r border-gray-100 bg-gray-50 flex items-center gap-2">
                  ...
                  {weekDays.map((day, dayIdx) => (
                    <div
                      key={dayIdx}
                      className={`p-3 border-r border-gray-100 last:border-r-0 min-h-[80px] ${
                    ...
                    >
                      {meds.map((med) => (
                        <div
                          key={med.id}
                          className="bg-teal-50 border border-teal-200 rounded-lg p-2 mb-2 last:mb-0"
                        >
